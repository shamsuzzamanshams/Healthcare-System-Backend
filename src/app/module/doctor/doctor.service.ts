...
const approveDoctor = async (payload : IApproveDoctorPayload, reviewer : RequstUser) => {
...
const updateDoctorProfile = async (payload : IUpdateDoctorProfilePayload, user : RequstUser) => {
	const existingDoctor = await prisma.doctor.findUnique({
